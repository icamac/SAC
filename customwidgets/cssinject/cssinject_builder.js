			...
			<div class="sapEpmUiFormSectionHeader">
				<div class="sapEpmUiFormSectionExpandableIconContainer">
					<button class="sapEpmUiFormSectionExpandableIcon">
						<span data-sap-ui="__icon1017" class="sapUiIcon sapUiIconMirrorInRTL" style="font-family: fpa-icons; transform: rotate(360deg);" aria-hidden="true" aria-label="expand/collapse"></span>
					</button>
				</div>
